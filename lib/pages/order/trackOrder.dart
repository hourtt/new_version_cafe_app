    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text(
            AppLocalizations.of(context)!.trackingOrder,
            style: TextStyle(
              color: Colors.white,
              fontSize: 25,
                  ...
                  children: [
                    _buildTimelineTile(
                      ...
                      description: AppLocalizations.of(context)!
                          .yourOrderCodeWasPlacedForDelivery,
                      isCompleted: true,
                    ),
                    _buildTimelineTile(
                      context,
                      ...
                      description: AppLocalizations.of(context)!
                          .yourOrderIsPendingForConfirmation,
                      isCompleted: true,
                    ),
                    _buildTimelineTile(
                      context,
                      ...
                      description: AppLocalizations.of(context)!
                          .yourOrderIsConfirmedAndWillBeReadySoon,
                      isCompleted: true,
                    ),
                    _buildTimelineTile(
                      context,
                    ...
                    _buildTimelineTile(
                      ...
                      description: AppLocalizations.of(context)!
                          .productDeliveredToYouAndMarkedAsDelivered,
                      isCompleted: false,
                    ),
                  ],
                ),
          ...
          Column(
            ...
            children: [
              ...
              Text(
                description,
                style: const TextStyle(
                    fontSize: 12.1, color: Color.fromARGB(255, 238, 233, 233)),
              ),
            ],
          ),
        ],
        ...
        content: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                AppLocalizations.of(context)!
                    .yourOrderHasAlreadyBeenServedThankYou,
                style: TextStyle(
                  fontSize: 15,
