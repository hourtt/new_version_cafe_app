...
// ignore_for_file: prefer_const_constructors, prefer_const_literals_to_create_immutables, use_key_in_widget_constructors, prefer_const_constructors_in_immutables, library_private_types_in_public_api, unnecessary_string_interpolations
...
//   // List of item names
//   final List<String> itemNames = [
//     // "${AppLocalizations.of(context)!.icedAmericano}",
...
//                     alignment: Alignment.centerLeft,
//                     child: Text(
//                       // AppLocalizations.of(context)!.[itemNames[i]],
//                       itemNames[i],
//                       style: TextStyle(
//                         fontSize: 18,
//                         fontWeight: FontWeight.bold,
